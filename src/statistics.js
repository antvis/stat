...
module.exports = {
  sum: require('simple-statistics/src/sum'),
  min: require('simple-statistics/src/min'),
  max: require('simple-statistics/src/max'),
  mean: require('simple-statistics/src/mean'),
